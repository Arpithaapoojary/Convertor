...
const TOOLS_REGISTRY = [
  // PDF Suite
  {
    ...
    category: "PDF Tools",
    icon: "layers",
    desc: "Combine multiple PDF documents into a single file in custom order.",
  },
  {
    id: "pdf-split",
    title: "Split PDF",
    category: "PDF Tools",
    icon: "split",
    desc: "Extract custom page ranges or split all pages into separate files.",
  },
  {
    id: "img-to-pdf",
    title: "Images to PDF",
    category: "PDF Tools",
    icon: "file-image",
    desc: "Convert JPG, PNG, and WebP images into a paginated PDF.",
  },
  {
    id: "text-to-pdf",
    title: "Text to PDF",
    category: "PDF Tools",
    icon: "file-text",
    desc: "Convert formatted notes and text into clean PDF documents.",
  },
  {
    id: "pdf-to-img",
    title: "PDF to Images",
    category: "PDF Tools",
    icon: "image",
    desc: "Render and extract high-resolution PNG or JPG pages from PDF.",
  },
  {
    id: "pdf-rotate",
    title: "Rotate PDF",
    category: "PDF Tools",
    icon: "rotate-cw",
    desc: "Rotate individual or all pages in a PDF document.",
  },
  {
    id: "pdf-metadata",
    ...
    category: "PDF Tools",
    icon: "file-search",
    desc: "Inspect PDF document metadata, page dimensions, creator, and security.",
  },
  ...
  // Image Studio
  {
    ...
    icon: "minimize-2",
    desc: "Compress JPG, PNG, and WebP images with live quality slider.",
  },
  {
    id: "img-convert",
    ...
    category: "Image Studio",
    icon: "refresh-cw",
    desc: "Convert between PNG, JPG, WebP, and other raster formats.",
  },
  {
    id: "img-b64",
    ...
    category: "Image Studio",
    icon: "binary",
    desc: "Encode images to Base64 Data URI strings or decode Base64 to image.",
  },
  {
    id: "img-palette",
    title: "Palette & Filters",
    category: "Image Studio",
    icon: "palette",
    desc: "Extract dominant color palettes and apply visual image filters.",
  },
  {
    id: "img-inspect",
    title: "Image Inspector & Ratio",
    category: "Image Studio",
    icon: "maximize",
    desc: "Inspect dimensions, aspect ratios, megapixels, and calculate scaling.",
  },
  {
    id: "img-svg",
    title: "SVG Studio & Optimizer",
    category: "Image Studio",
    icon: "sparkles",
    desc: "Minify SVG vector code, recolor, scale, and export as crisp PNG/WebP.",
  },
  {
    id: "img-watermark",
    title: "Watermark & Privacy",
    category: "Image Studio",
    icon: "stamp",
    desc: "Add customizable text/tile watermarks and strip all camera/EXIF metadata.",
  },
  ...
  // Text & Content
  {
    ...
    icon: "type",
    desc: "Case conversion, line cleaning, sorting, and text formatting.",
  },
  {
    id: "text-diff",
    ...
    category: "Text & Content",
    icon: "git-compare",
    desc: "Find differences between two texts side-by-side.",
  },
  {
    id: "text-password",
    ...
    category: "Text & Content",
    icon: "lock",
    desc: "Generate secure random passwords and passphrases with entropy score.",
  },
  {
    id: "text-regex",
    ...
    category: "Text & Content",
    icon: "code-2",
    desc: "Interactive regular expression playground with live match highlights and capture groups.",
  },
  {
    id: "text-table",
    ...
    category: "Text & Content",
    icon: "table-2",
    desc: "Visual markdown table builder, CSV importer, and multi-format table code generator.",
  },
  ...
  // Data & Code
  {
    ...
    icon: "table",
    desc: "Convert CSV to JSON and JSON to CSV with live table preview.",
  },
  {
    id: "data-color",
    title: "Color Studio & Converter",
    category: "Data & Format",
    icon: "palette",
    desc: "HEX, RGB, HSL, CMYK converter, harmony generator & color shades.",
  },
  {
    id: "data-json-beautifier",
    title: "JSON Studio",
    category: "Data & Format",
    icon: "braces",
    desc: "Format, minify, repair syntax, and validate JSON data structures.",
  },
  {
    id: "data-jwt",
    title: "JWT Inspector",
    category: "Data & Format",
    icon: "key-round",
    desc: "Decode, inspect, and validate JSON Web Tokens with timestamp checks.",
  },
  {
    id: "data-html-xml",
    title: "HTML & XML Studio",
    category: "Data & Format",
    icon: "file-code-2",
    desc: "Beautify, format, minify HTML/XML, encode entities, and preview rendered HTML.",
  },
  {
    id: "data-markdown",
    ...
    category: "Data & Format",
    icon: "file-code",
    desc: "Real-time Markdown editor with rendered HTML preview.",
  },
  {
    id: "data-encode",
    ...
    category: "Data & Format",
    icon: "shield",
    desc: "Encode and decode Base64, URL components, and HTML entities.",
  },
  {
    id: "data-hash-uuid",
    ...
    category: "Data & Format",
    icon: "hash",
    desc: "Generate MD5, SHA-256 hashes and bulk UUID v4 strings.",
  },
  {
    id: "data-timestamp",
    title: "Timestamp & Epoch Studio",
    category: "Data & Format",
    icon: "clock",
    desc: "Unix timestamp converter, world timezone clock matrix, and date duration calculator.",
  },
  ...
  // QR & Barcode Studio
  {
    ...
    category: "QR & Barcode",
    icon: "qr-code",
    desc: "Create custom QR codes for URLs, WiFi, contacts, and text.",
  },
  {
    id: "qr-scanner",
    ...
    category: "QR & Barcode",
    icon: "scan",
    desc: "Scan and decode QR codes directly from uploaded images.",
  },
  {
    id: "barcode-generator",
    title: "Barcode 128 Studio",
    category: "QR & Barcode",
    icon: "barcode",
    desc: "Generate Code 128 barcodes with custom dimensions and SVG export.",
  },
];
...
class OmniDocApp {
  constructor() {
    ...
    this.recentTools = JSON.parse(
      localStorage.getItem("omnidoc_recent_tools") || "[]",
    );
    this.favoriteTools = new Set(
      JSON.parse(
        localStorage.getItem("omnidoc_favorite_tools") ||
          '["pdf-merge", "img-compress", "text-transform", "data-csv-json", "qr-generator"]',
      ),
    );
  ...
  toggleFavorite(toolId, e) {
    ...
    localStorage.setItem(
      "omnidoc_favorite_tools",
      JSON.stringify(Array.from(this.favoriteTools)),
    );
    this.renderFavoritesSection();
  ...
  injectNavStarButtons() {
    document
      .querySelectorAll(
        ".sidebar-nav div:not(#sidebar-favorites-section) .nav-item",
      )
      .forEach((item) => {
  ...
  applyAccent(accentName) {
    ...
    document.querySelectorAll(".accent-dot-btn").forEach((btn) => {
      btn.classList.toggle(
        "active",
        btn.getAttribute("data-accent") === accentName,
      );
    });
  }
  ...
  recordRecentTool(toolId) {
    ...
    localStorage.setItem(
      "omnidoc_recent_tools",
      JSON.stringify(this.recentTools),
    );
  ...
  toggleZenMode() {
    ...
    showToast(
      isZen ? "Entered Zen Mode (Distraction-Free)" : "Exited Zen Mode",
      "info",
    );
  }
    ...
    if (soundBtn) {
      ...
      soundBtn.addEventListener("click", () => {
        const currentlyMuted =
          localStorage.getItem("omnidoc_sound_muted") === "true";
        ...
        if (window.lucide) lucide.createIcons();
        showToast(
          nextMuted ? "Audio feedback muted" : "Audio feedback enabled",
          "info",
        );
      });
    }
      ...
      input.addEventListener("input", (e) => {
        ...
        if (
          ...
          this.filteredPaletteTools = TOOLS_REGISTRY.filter((t) =>
            this.favoriteTools.has(t.id),
          );
        } else {
          this.filteredPaletteTools = TOOLS_REGISTRY.filter(
            (t) =>
      ...
      input.addEventListener("keydown", (e) => {
        if (e.key === "ArrowDown") {
          ...
          this.paletteSelectedIndex =
            (this.paletteSelectedIndex + 1) % this.filteredPaletteTools.length;
          this.renderPaletteResults();
        } else if (e.key === "ArrowUp") {
          e.preventDefault();
          this.paletteSelectedIndex =
            (this.paletteSelectedIndex - 1 + this.filteredPaletteTools.length) %
            this.filteredPaletteTools.length;
          this.renderPaletteResults();
        } else if (e.key === "Enter") {
          e.preventDefault();
          if (this.filteredPaletteTools[this.paletteSelectedIndex]) {
            this.navigateTo(
              this.filteredPaletteTools[this.paletteSelectedIndex].id,
            );
            this.closePalette();
          }
        }
