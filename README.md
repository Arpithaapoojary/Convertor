...
![Tools Count](https://img.shields.io/badge/Tools-22%2B-violet?style=for-the-badge)

OmniDoc Studio is a privacy-first, zero-telemetry web application featuring **22+ high-performance utilities** for processing PDFs, optimizing images, transforming text, generating secure passwords, converting data structures, inspecting tokens, creating barcodes, and generating QR codes directly in your browser without uploading files to any external server.

---

## 🚀 Complete Suite of 22+ Utilities
...
### ✍️ 3. Text & Content Studio (3 Tools)
...
| Shortcut | Action |
| :--- | :--- |
| **`Ctrl + K`** / **`Cmd + K`** | Open Command Palette to search across all 22+ tools |
